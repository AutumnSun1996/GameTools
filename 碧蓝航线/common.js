...
- 驱逐:
  ...
  - 稀有:
    - [x]格里德利, [x]弗莱彻, [x]撒切尔, [ ]本森, [x]西姆斯, [x]哈曼, [x]女将, [ ]阿卡司塔, [ ]热心, [x]命运女神, [x]天后, [ ]晓(枫), [x]雷(梓), [x]电(柏), [x]白露(梿), [x]阳炎(萩), [ ]初春(梅), [ ]若叶(楉), [ ]初霜(檨), [ ]有明(榎), [ ]夕暮(棭), [ ]黑潮(蓉), [x]亲潮(藮), [ ]贝利, [x]Z19, [ ]神风(榊), [x]松风(棡), [ ]文月(橗), [x]拉德福特, [x]杰金斯, [ ]丘比特, [ ]泽西, [ ]浦风(槆), [ ]矶风(柉), [x]滨风(樇), [x]谷风(栭), [ ]朝潮(棹), [ ]大潮(荙), [ ]满潮(樠), [ ]荒潮(栘), [x]Z18, [x]福尔班, [x]勒马尔, [x]布什
  - 精锐:
    - [x]泛用型布里, [ ]莫里, [x]查尔斯·奥斯本, [x]拉菲, [x]萤火虫, [x]标枪, [x]吸血鬼, [ ]吹雪(桐), [x]绫波(柚), [x]时雨(栴), [ ]野分(苓), [x]Z1, [x]Z23, [x]Z25, [ ]鞍山, [ ]抚顺, [ ]长春, [ ]太原, [ ]新月JP(枥), [ ]春月(桸), [ ]宵月(楛), [x]尼古拉斯, [ ]无敌, [ ]火枪手, [x]Z35, [ ]布兰, [ ]22, [ ]33
  - 超稀有:
...
- 轻巡:
  ...
  - 精锐:
    - [x]海伦娜, [x]克利夫兰, [ ]哥伦比亚, [ ]谢菲尔德, [ ]爱丁堡, [ ]欧若拉, [x]夕张(狐), [ ]最上(猨), [ ]三隈(狻), [ ]逸仙, [ ]宁海, [ ]平海, [x]圣路易斯, [ ]神通(貎), [ ]阿贺野(豼), [ ]丹佛, [ ]小贝法, [x]埃米尔·贝尔汀, [ ]涅普顿
  - 超稀有:
...
- 改造:
  - 驱逐:
    - [ ]卡辛.改, [ ]唐斯.改, [ ]拉菲.改, [ ]哈曼.改, [ ]阿卡司塔.改, [ ]热心.改, [ ]彗星.改, [ ]新月.改, [ ]小天鹅.改, [ ]狐提.改, [ ]命运女神.改, [ ]标枪.改, [ ]绫波.改, [ ]阳炎.改, [ ]不知火.改, [x]Z23.改, [ ]贝利.改, [ ]神风.改, [ ]松风.改, [ ]睦月.改, [ ]尼古拉斯.改, [ ]滨风.改, [ ]谷风.改, [ ]福尔班.改, [ ]勒马尔.改
  - 重巡:
