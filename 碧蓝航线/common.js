...
- 驱逐:
  ...
  - 稀有:
    - [x]格里德利, [x]弗莱彻, [x]撒切尔, [x]本森, [x]西姆斯, [x]哈曼, [x]女将, [ ]阿卡司塔, [x]热心, [x]命运女神, [x]天后, [ ]晓(枫), [x]雷(梓), [x]电(柏), [x]白露(梿), [x]阳炎(萩), [ ]初春(梅), [ ]若叶(楉), [ ]初霜(檨), [ ]有明(榎), [ ]夕暮(棭), [x]黑潮(蓉), [x]亲潮(藮), [ ]贝利, [x]Z19, [x]神风(榊), [x]松风(棡), [ ]文月(橗), [x]拉德福特, [x]杰金斯, [ ]丘比特, [ ]泽西, [x]浦风(槆), [x]矶风(柉), [x]滨风(樇), [x]谷风(栭), [ ]朝潮(棹), [ ]大潮(荙), [ ]满潮(樠), [x]荒潮(栘), [x]Z18, [x]福尔班, [x]勒马尔, [x]布什, [x]霍比, [x]科尔克, [x]黑泽伍德
  - 精锐:
...
- 轻巡:
  ...
  - 精锐:
    - [x]海伦娜, [x]克利夫兰, [ ]哥伦比亚, [ ]谢菲尔德, [ ]爱丁堡, [x]欧若拉, [x]夕张(狐), [ ]最上(猨), [ ]三隈(狻), [x]逸仙, [x]宁海, [x]平海, [x]圣路易斯, [ ]神通(貎), [ ]阿贺野(豼), [ ]丹佛, [x]小贝法, [x]埃米尔·贝尔汀, [ ]涅普顿
  - 超稀有:
