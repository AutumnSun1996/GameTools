...
- 驱逐:
  ...
  - 稀有:
    - [x]格里德利, [x]弗莱彻, [x]撒切尔, [x]本森, [x]西姆斯, [x]哈曼, [x]女将, [ ]阿卡司塔, [x]热心, [x]命运女神, [x]天后, [x]晓(枫), [x]雷(梓), [x]电(柏), [x]白露(梿), [x]阳炎(萩), [ ]初春(梅), [ ]若叶(楉), [ ]初霜(檨), [ ]有明(榎), [x]夕暮(棭), [x]黑潮(蓉), [x]亲潮(藮), [ ]贝利, [x]Z19, [x]神风(榊), [x]松风(棡), [ ]文月(橗), [x]长月(枨), [x]拉德福特, [x]杰金斯, [ ]丘比特, [ ]泽西, [x]浦风(槆), [x]矶风(柉), [x]滨风(樇), [x]谷风(栭), [ ]朝潮(棹), [ ]大潮(荙), [ ]满潮(樠), [x]荒潮(栘), [x]Z18, [x]福尔班, [x]勒马尔, [x]布什, [x]霍比, [x]科尔克, [x]黑泽伍德, [x]旗风(樋)
  - 精锐:
    - [x]泛用型布里, [ ]莫里, [x]查尔斯·奥斯本, [x]拉菲, [x]萤火虫, [x]标枪, [x]吸血鬼, [ ]吹雪(桐), [x]绫波(柚), [x]时雨(栴), [x]野分(苓), [x]Z1, [x]Z23, [x]Z25, [ ]鞍山, [ ]抚顺, [ ]长春, [ ]太原, [x]新月JP(枥), [ ]春月(桸), [ ]宵月(楛), [x]尼古拉斯, [ ]无敌, [ ]火枪手, [x]Z35, [x]鲁莽, [x]卷波(棬), [ ]布兰, [ ]22, [ ]33
  - 超稀有:
    - [x]试作型布里MKII, [x]埃尔德里奇, [x]夕立(椿), [ ]雪风(莲), [x]Z46, [ ]江风(茳), [x]凯旋, [ ]群白之心, [x]猫音
- 轻巡:
  - 常见:
    - [x]奥马哈, [x]罗利, [x]利安得, [x]长良(貊), [x]阿武隈(貃), [x]柯尼斯堡, [x]卡尔斯鲁厄, [x]科隆, [x]里士满
  - 稀有:
    - [x]布鲁克林, [x]菲尼克斯, [x]亚特兰大, [x]朱诺, [x]阿基里斯, [x]阿贾克斯, [x]阿瑞托莎, [x]加拉蒂亚, [x]五十铃(貉), [ ]莱比锡, [x]火奴鲁鲁, [ ]川内(貆), [x]那珂(豻), [ ]斐济, [ ]牙买加, [x]孟菲斯, [x]纽卡斯尔, [x]康克德
  - 精锐:
    - [x]海伦娜, [x]克利夫兰, [ ]哥伦比亚, [ ]谢菲尔德, [x]爱丁堡, [x]欧若拉, [x]夕张(狐), [ ]最上(猨), [ ]三隈(狻), [x]逸仙, [x]宁海, [x]平海, [x]圣路易斯, [x]神通(貎), [ ]阿贺野(豼), [x]丹佛, [x]小贝法, [x]埃米尔·贝尔汀, [ ]涅普顿
  - 超稀有:
    - [x]圣地亚哥, [x]贝尔法斯特, [ ]阿芙乐尔, [x]蒙彼利埃, [ ]绀紫之心, [x]露露缇耶
  - 方案:
    - [x]海王星
- 重巡:
  - 常见:
  ...
  - 精锐:
    - [x]休斯敦, [x]印第安纳波利斯, [x]阿斯托利亚, [x]昆西, [x]文森斯, [ ]威奇塔, [x]伦敦, [ ]多塞特郡, [x]约克, [x]埃克塞特, [x]足柄(狳), [x]希佩尔海军上将, [x]德意志, [x]斯佩伯爵海军上将, [ ]诺瓦露
  - 超稀有:
    - [x]高雄(獒), [x]爱宕(犬), [x]摩耶(犮), [ ]鸟海(猋), [x]欧根亲王, [x]明尼阿波利斯, [ ]圣黑之心, [x]久远
  - 方案:
    - [x]伊吹(峦), [x]罗恩, [x]路易九世
- 战巡:
  - 稀有:
...
- 战列:
  ...
  - 超稀有:
    - [x]北卡罗来纳, [x]华盛顿, [x]南达科他, [x]厌战, [ ]威尔士亲王, [ ]约克公爵, [ ]长门(鲨), [ ]提尔比茨, [x]三笠(鲐), [ ]让·巴尔, [x]马萨诸塞, [x]加贺BB
  - 方案:
    - [x]君主, [ ]出云(侌)
- 航母:
  - 稀有:
    - [x]胡蜂
  - 精锐:
    - [x]列克星敦, [x]萨拉托加, [x]约克城, [x]大黄蜂, [x]皇家方舟, [ ]光荣, [x]苍龙(蛟), [x]飞龙(龙), [ ]贝露, [x]芙米露露
  - 超稀有:
...
- 轻航:
  ...
  - 精锐:
    - [x]独角兽, [x]凤翔(凤), [x]龙骧(枭), [x]乌璐露, [x]萨拉娜
  - 超稀有:
    - [ ]半人马
- 重炮:
  - 精锐:
...
- 改造:
  ...
  - 轻巡:
    - [x]圣地亚哥.改, [x]利安得.改, [ ]阿基里斯.改, [ ]阿贾克斯.改, [ ]阿武隈.改, [ ]最上.改, [ ]卡尔斯鲁厄.改, [x]宁海.改, [ ]平海.改, [ ]川内.改, [ ]神通.改, [ ]纽卡斯尔.改
  - 重巡:
    - [x]波特兰.改, [ ]萨福克.改, [ ]约克.改, [ ]埃克塞特.改, [ ]古鹰.改, [ ]加古.改
  - 战列:
...
var 联动 = `
涅普顿 诺瓦露 布兰 贝露 绀紫之心 圣黑之心 群白之心 翡绿之心 
22 33 
久远 猫音 露露缇耶 乌璐露 萨拉娜 芙米露露
`.replace(/[\s（）()]+/g, " ").trim().split(" ")
...
function shipCount() {
  var count = {"总计": 0, "已有": 0, "联动": 0, "已有联动": 0, "改造": 0, "已改造": 0, };
  var regShip = /\[([x ])\]([^\s(),]+)(?:\(([^\s]+)\))?/g;
