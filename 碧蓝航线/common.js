...
- 驱逐:
  ...
  - 稀有:
    - [x]格里德利, [x]弗莱彻, [x]撒切尔, [x]本森, [x]西姆斯, [x]哈曼, [x]女将, [ ]阿卡司塔, [x]热心, [x]命运女神, [x]天后, [x]晓(枫), [x]雷(梓), [x]电(柏), [x]白露(梿), [x]阳炎(萩), [ ]初春(梅), [ ]若叶(楉), [ ]初霜(檨), [ ]有明(榎), [x]夕暮(棭), [x]黑潮(蓉), [x]亲潮(藮), [ ]贝利, [x]Z19, [x]神风(榊), [x]松风(棡), [ ]文月(橗), [x]长月(枨), [x]拉德福特, [x]杰金斯, [ ]丘比特, [ ]泽西, [x]浦风(槆), [x]矶风(柉), [x]滨风(樇), [x]谷风(栭), [ ]朝潮(棹), [ ]大潮(荙), [ ]满潮(樠), [x]荒潮(栘), [x]Z18, [x]福尔班, [x]勒马尔, [x]布什, [x]霍比, [x]科尔克, [x]黑泽伍德
  - 精锐:
...
- 轻巡:
  ...
  - 稀有:
    - [x]布鲁克林, [x]菲尼克斯, [x]亚特兰大, [x]朱诺, [x]阿基里斯, [x]阿贾克斯, [x]阿瑞托莎, [x]加拉蒂亚, [x]五十铃(貉), [ ]莱比锡, [x]火奴鲁鲁, [ ]川内(貆), [ ]斐济, [ ]牙买加, [x]孟菲斯, [x]纽卡斯尔, [x]康克德
  - 精锐:
...
- 重巡:
  ...
  - 精锐:
    - [x]休斯敦, [x]印第安纳波利斯, [x]阿斯托利亚, [x]昆西, [x]文森斯, [ ]威奇塔, [x]伦敦, [ ]多塞特郡, [x]约克, [x]埃克塞特, [x]希佩尔海军上将, [x]德意志, [x]斯佩伯爵海军上将, [ ]诺瓦露
  - 超稀有:
