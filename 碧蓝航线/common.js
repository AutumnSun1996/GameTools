...
- 驱逐:
  ...
  - 稀有:
    - [x]格里德利, [x]弗莱彻, [x]撒切尔, [ ]本森, [x]西姆斯, [x]哈曼, [x]女将, [ ]阿卡司塔, [ ]热心, [x]命运女神, [x]天后, [ ]晓(枫), [x]雷(梓), [x]电(柏), [x]白露(梿), [x]阳炎(萩), [ ]初春(梅), [ ]若叶(楉), [ ]初霜(檨), [ ]有明(榎), [ ]夕暮(棭), [x]黑潮(蓉), [x]亲潮(藮), [ ]贝利, [x]Z19, [ ]神风(榊), [x]松风(棡), [ ]文月(橗), [x]拉德福特, [x]杰金斯, [ ]丘比特, [ ]泽西, [ ]浦风(槆), [ ]矶风(柉), [x]滨风(樇), [x]谷风(栭), [ ]朝潮(棹), [ ]大潮(荙), [ ]满潮(樠), [x]荒潮(栘), [x]Z18, [x]福尔班, [x]勒马尔, [x]布什
  - 精锐:
...
- 潜艇:
  ...
  - 超稀有:
    - [ ]伊19, [ ]U-81, [x]U-47, [x]大青花鱼
- 改造:
  - 驱逐:
    - [ ]卡辛.改, [ ]唐斯.改, [ ]拉菲.改, [ ]哈曼.改, [ ]阿卡司塔.改, [ ]热心.改, [ ]彗星.改, [ ]新月.改, [ ]小天鹅.改, [ ]狐提.改, [ ]命运女神.改, [ ]标枪.改, [x]绫波.改, [x]阳炎.改, [ ]不知火.改, [x]Z23.改, [ ]贝利.改, [ ]神风.改, [ ]松风.改, [ ]睦月.改, [ ]尼古拉斯.改, [ ]滨风.改, [ ]谷风.改, [ ]福尔班.改, [ ]勒马尔.改
  - 重巡:
...
155mm三连装炮T3金(3): 1
双联装TbtsKC36式150mm主炮T3紫(6): 4

#重巡主炮:
试作型三联装203mmSKC主炮T0金(3): 1
试作型三联装203mm舰炮T0金(3): 1
双联装203mmSKC主炮T3金(3): 3

#战列主炮:
三联装406mm主炮MK6T3紫(4): 5
410mm连装炮T3紫(3): 8
双联装381mm主炮.改T0金(1): 1
试做型410mm三连装炮金(1): 1
...
100mm连装高炮T0金(3): 1
双联105mmSKC高炮T3金(3): 2
双联装40mm博福斯STAAGT0金(3): 1
四联40mm博福斯对空机炮T3金(3): 1
八联装40mm“砰砰”炮T3金(3): 1
