...
- 驱逐:
  ...
  - 稀有:
    - [x]格里德利, [x]弗莱彻, [x]撒切尔, [ ]本森, [x]西姆斯, [x]哈曼, [x]女将, [ ]阿卡司塔, [ ]热心, [x]命运女神, [x]天后, [ ]晓(枫), [ ]雷(梓), [ ]电(柏), [x]白露(梿), [x]阳炎(萩), [ ]初春(梅), [ ]若叶(楉), [ ]初霜(檨), [ ]有明(榎), [ ]夕暮(棭), [ ]黑潮(蓉), [ ]亲潮(藮), [ ]贝利, [ ]神风(榊), [x]松风(棡), [ ]文月(橗), [ ]拉德福特, [ ]杰金斯, [ ]丘比特, [ ]泽西, [ ]浦风(槆), [ ]矶风(柉), [ ]滨风(樇), [x]谷风(栭), [ ]朝潮(棹), [ ]大潮(荙), [ ]满潮(樠), [x]Z18, [x]Z19, [x]福尔班, [x]勒马尔
  - 精锐:
...
- 改造:
  - 驱逐:
    - [ ]卡辛.改, [ ]唐斯.改, [ ]拉菲.改, [ ]哈曼.改, [ ]阿卡司塔.改, [ ]热心.改, [ ]彗星.改, [ ]新月.改, [ ]小天鹅.改, [ ]狐提.改, [ ]命运女神.改, [ ]标枪.改, [ ]绫波.改, [ ]不知火.改, [ ]Z23.改, [ ]贝利.改, [ ]神风.改, [ ]松风.改, [ ]睦月.改, [ ]尼古拉斯.改, [ ]滨风.改, [ ]谷风.改, [ ]福尔班.改, [ ]勒马尔.改
  - 重巡:
...
#驱逐主炮:
138.6mm单装炮Mle1929T3金(1): 1
138.6mm单装炮Mle1929T3紫(6): 3+1/10
双联装127mm高平两用炮MK12T3金(6): 0
双联装120mm主炮T3紫(6): 5+1/10
127mm单装炮T3紫(6): 3
